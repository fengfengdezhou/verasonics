    ...
    methods
        ...
        function [ list, values] = listImportProperties(this)
            ...
            if nargout > 1
                values = {  this.srcData; ...
                            ...
                            this.compressMethod; ...
                            this.compressFactor; ...
                            %this.mappingMethod; ... % Mapping Method should not be alowed to be imported and shared between
                                                     %imaging modes
                            this.threshold};
            end
        end
        ...
        function list = listSupportedProperties(~)
            list =  {   'srcData'; ...
                        ...
                        'compressMethod'; ...
                        'compressFactor'; ...
                        %'mappingMethod'; ... % Mapping Method should not be alowed to be imported and shared between
                                              %imaging modes
                        'threshold'};
        end
