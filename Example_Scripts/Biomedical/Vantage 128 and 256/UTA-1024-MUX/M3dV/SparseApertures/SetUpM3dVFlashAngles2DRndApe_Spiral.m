%
% File name: SetUpM3dVFlashAngles2DRndApe_Spiral.m - Example of angle compounding
...
%  each subapertures.
%  A set of 100 Random Apertures to be used for each transmit have been 
%  created for this script which are loaded from a .mat file "Saved100RndApod".
%  This random apertues respect the contraints of the mux switches.
...
save('MatFiles/M3dV-FlashAngles2DRndApe-Spiral.mat');
