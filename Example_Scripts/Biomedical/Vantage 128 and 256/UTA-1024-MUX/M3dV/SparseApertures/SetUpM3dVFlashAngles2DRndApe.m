%
% File name: SetUpM3dVFlashAngles2DRndApe.m - Example of angle compounding
...
%
%  In this script the user defines a set of Angles defined by TxAngles. 
%  The user needs to specify the + and - angles in degrees which should be 
%  symmetric. For each of this angles a series of transmits around 2*pi are
%  calculated using different Random Apertures. If the  number of angles in
...
%  na2 = 9 is a transmit every 45 degrees. 
%  
...
%  case of this script the average time for the reconstruction time for the
...
%  case for this script the number of angles should be larger than 18
...
save('MatFiles/M3dV-FlashAngles2DRndApe.mat');
