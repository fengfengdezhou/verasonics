%
% File name: SetUpM3dVWideBeam_RndApe.m - Example of WideBeam imaging 
%                       for volume acquisitions using a matrix probe (3 MHz),
...
save('MatFiles/M3dV-WideBeam_RndApe.mat');
