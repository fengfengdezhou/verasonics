%
% File name: SetUpM3dVFullFlash.m - Example of imaging with single
%                                   plane wave using the Matrix 3MHz probe
%                                  
% Description:
%  Sequence programming file for 3MHz matrix probe for plane wave imaging using 
%  the  mux programming ability to set HVMux switches to select elements in parallel.
%  This script does a single flash transmit over all 1024 elements. The
%  receive is done using four synthetic apertures of 256 elements each.
...
save('MatFiles/M3dV-FullFlash.mat');
