%
% File name: SetUpM3dVWideBeam_SRAC.m - Example of WideBeam imaging 
%                       for volume acquisitions using a matrix probe (3 MHz) and
...
%  however the receive of the backscatter data will be done with different random 
...
%  The script loads two files, one with the Random apertures for the Transmit 
%  "Saved256RndApodOrigin", with 256 distinct randome apertures. The second file is 
%  "saved100CompRndApod" which has 100 sets with  4 complementary random apertures each.
...
save('MatFiles/M3dV-WideBeam_SRAC.mat');
return
