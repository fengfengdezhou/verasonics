%
% File name: SetUpM3dVFlashAngles_Spiral_SRAC.m - Example of FlashAngles 
...
%  volume reconstruction. The scanning patern in this script follow spiral
%  around the z axis. The spiral patter rotates twice around the z axis in
%  "na" steps (the number of steps can be modified by the user). Therefore in 
...
save('MatFiles/M3dV-FlashAngles_Spiral_SRAC.mat');
return
