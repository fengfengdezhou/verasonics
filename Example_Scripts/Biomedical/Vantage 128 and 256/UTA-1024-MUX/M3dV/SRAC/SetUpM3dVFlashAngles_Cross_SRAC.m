%
% File name: SetUpM3dVFlashAngles_Cross_SRAC.m - Example of FlashAngles 
%                       imaging for volume acquisitions using a matrix probe array (3 MHz) and
%                       Sparse Random Aperture Compounding (SRAC) technique.
%                                  
% Description:
%  This scripts transmits and receives "na" steer waves for compounding and
%  volume recontruction. The number of angles (na) is determined by the
%  vector defined by the user in TxAngles, which is specified in degrees. 
%  The default for na is 10. The scanning pattern in this script follows a "cross",
%  with 5 beams being transmited by tilting the plane in the XZ direction
%  and 5 beams in the YZ direction. 
...
%  The script loads a file named "saved100CompRndApod" which has 100 sets with 
%  4 complementary random apertures each.
...
save('MatFiles/M3dV-FlashAngles_Cross_SRAC.mat');
return
