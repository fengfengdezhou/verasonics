%
% File name: SetUpM3dVFlash_SRAC.m - Example of Flash imaging for volume
%                               acquisition using a matrix probe array (3 MHz) and 
%                               Sparse Random Aperture Compounding (SRAC) technique.
%                                  
% Description:
%  This scripts transmits and receives a single diverging wave for volume reconstruciton. 
...
save('MatFiles/M3dV-Flash_SRAC.mat');
return
